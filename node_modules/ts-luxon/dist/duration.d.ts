...
export declare class Duration implements NormalizedDurationObject {
     ...
     * @return {Duration}
     */
    static fromISOTime(text: string, opts?: DurationOptions & ThrowOnInvalid): Duration;
    ...
    }): DurationObject & Partial<DurationOptions>;
    /**
 ...
 * @private
 */
export declare function friendlyDuration(durationish: DurationLike | number): Duration;
export {};
