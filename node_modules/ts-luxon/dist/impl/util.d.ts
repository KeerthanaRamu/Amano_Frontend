...
export declare function bestBy<T, U>(arr: T[], by: (a: T) => U, compare: (a: U, b: U) => U): T;
export declare function pick<T, K extends keyof T>(obj: T, keys: K[]): Pick<T, K>;
export declare function hasOwnProperty(obj: object, prop: string): boolean;
...
export declare function normalizeObject(obj: Record<string, unknown>, normalizer: (key: string) => string | number, nonUnitKeys?: string[]): {
    [key: string]: number;
};
