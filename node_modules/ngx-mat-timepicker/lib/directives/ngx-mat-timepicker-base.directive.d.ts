...
export declare class NgxMatTimepickerBaseDirective implements OnInit, OnDestroy {
    ...
    protected _subsCtrl$: Subject<unknown>;
    constructor(_timepickerSrv: NgxMatTimepickerService, _eventSrv: NgxMatTimepickerEventService, _locale: string, data: any);
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgxMatTimepickerBaseDirective, [null, null, null, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NgxMatTimepickerBaseDirective, "[ngxMatTimepickerBase]", never, { "color": "color"; "defaultTime": "defaultTime"; }, {}, never>;
}

//# sourceMappingURL=ngx-mat-timepicker-base.directive.d.ts.map